...
class AppModuleInjector extends import0.NgModuleInjector<import1.AppModule> {
  ...
  _ModalModule_8:import9.ModalModule;
  _FileUploadModule_9:import10.FileUploadModule;
  ...
  _NoPreloading_53:import33.NoPreloading;
  _PreloadingStrategy_54:any;
  _RouterPreloader_55:import33.RouterPreloader;
  __PreloadAllModules_56:import33.PreloadAllModules;
  __ROUTER_INITIALIZER_57:any;
  __APP_BOOTSTRAP_LISTENER_58:any[];
  __PositioningService_59:import34.PositioningService;
  __ComponentLoaderFactory_60:import35.ComponentLoaderFactory;
  __AuthHttp_61:any;
  __DataService_62:import36.DataService;
  __YQLService_63:import37.YQLService;
  __NoticeBoardService_64:import38.NoticeBoardService;
  __ToastService_65:import39.ToastService;
  __UserService_66:import40.UserService;
  ...
  get _EventManager_23():import17.EventManager {
    if ((this.__EventManager_23 == null)) { (this.__EventManager_23 = new import17.EventManager(this._EVENT_MANAGER_PLUGINS_22,this.parent.get(import51.NgZone))); }
  ...
  get _AnimationQueue_31():import21.AnimationQueue {
    if ((this.__AnimationQueue_31 == null)) { (this.__AnimationQueue_31 = new import21.AnimationQueue(this.parent.get(import51.NgZone))); }
  ...
  get _BrowserXhr_37():import24.BrowserXhr {
    if ((this.__BrowserXhr_37 == null)) { (this.__BrowserXhr_37 = new import24.BrowserXhr()); }
  ...
  get _XHRBackend_40():import26.XHRBackend {
    if ((this.__XHRBackend_40 == null)) { (this.__XHRBackend_40 = new import26.XHRBackend(this._BrowserXhr_37,this._ResponseOptions_38,this._XSRFStrategy_39)); }
    return this.__XHRBackend_40;
  }
  get _RequestOptions_41():import27.BaseRequestOptions {
    if ((this.__RequestOptions_41 == null)) { (this.__RequestOptions_41 = new import27.BaseRequestOptions()); }
  ...
  get _LocationStrategy_45():any {
    if ((this.__LocationStrategy_45 == null)) { (this.__LocationStrategy_45 = import8.provideLocationStrategy(this.parent.get(import53.PlatformLocation),this.parent.get(import54.APP_BASE_HREF,(null as any)),this._ROUTER_CONFIGURATION_44)); }
  ...
  get _PreloadAllModules_56():import33.PreloadAllModules {
    if ((this.__PreloadAllModules_56 == null)) { (this.__PreloadAllModules_56 = new import33.PreloadAllModules()); }
    return this.__PreloadAllModules_56;
  }
  get _ROUTER_INITIALIZER_57():any {
    if ((this.__ROUTER_INITIALIZER_57 == null)) { (this.__ROUTER_INITIALIZER_57 = import8.initialRouterNavigation(this._Router_51,this._ApplicationRef_17,this._RouterPreloader_55,this._ROUTER_CONFIGURATION_44)); }
  ...
  get _PositioningService_59():import34.PositioningService {
    if ((this.__PositioningService_59 == null)) { (this.__PositioningService_59 = new import34.PositioningService()); }
    return this.__PositioningService_59;
  }
  get _ComponentLoaderFactory_60():import35.ComponentLoaderFactory {
    if ((this.__ComponentLoaderFactory_60 == null)) { (this.__ComponentLoaderFactory_60 = new import35.ComponentLoaderFactory(this,this.parent.get(import51.NgZone),this,this._PositioningService_59)); }
    return this.__ComponentLoaderFactory_60;
  }
  get _AuthHttp_61():any {
    if ((this.__AuthHttp_61 == null)) { (this.__AuthHttp_61 = import1.getAuthHttp(this._Http_42)); }
    return this.__AuthHttp_61;
  }
  get _DataService_62():import36.DataService {
    if ((this.__DataService_62 == null)) { (this.__DataService_62 = new import36.DataService(this._Http_42,this._AuthHttp_61)); }
    return this.__DataService_62;
  }
  get _YQLService_63():import37.YQLService {
    if ((this.__YQLService_63 == null)) { (this.__YQLService_63 = new import37.YQLService(this._Http_42)); }
    return this.__YQLService_63;
  }
  get _NoticeBoardService_64():import38.NoticeBoardService {
    if ((this.__NoticeBoardService_64 == null)) { (this.__NoticeBoardService_64 = new import38.NoticeBoardService(this._Http_42)); }
    return this.__NoticeBoardService_64;
  }
  get _ToastService_65():import39.ToastService {
    if ((this.__ToastService_65 == null)) { (this.__ToastService_65 = new import39.ToastService()); }
    return this.__ToastService_65;
  }
  get _UserService_66():import40.UserService {
    if ((this.__UserService_66 == null)) { (this.__UserService_66 = new import40.UserService(this._Http_42)); }
  ...
  createInternal():import1.AppModule {
    ...
    this._ApplicationRef__16 = new import14.ApplicationRef_(this.parent.get(import51.NgZone),this.parent.get(import61.Console),this,this._ErrorHandler_13,this,this._ApplicationInitStatus_14,this.parent.get(import13.TestabilityRegistry,(null as any)),this._Testability_15);
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import9.ModalModule)) { return this._ModalModule_8; }
    if ((token === import10.FileUploadModule)) { return this._FileUploadModule_9; }
    ...
    if ((token === import67.IterableDiffers)) { return this._IterableDiffers_33; }
    if ((token === import68.KeyValueDiffers)) { return this._KeyValueDiffers_34; }
    ...
    if ((token === import54.LocationStrategy)) { return this._LocationStrategy_45; }
    ...
    if ((token === import71.NgModuleFactoryLoader)) { return this._NgModuleFactoryLoader_49; }
    if ((token === import72.ROUTES)) { return this._ROUTES_50; }
    if ((token === import60.Router)) { return this._Router_51; }
    if ((token === import73.ActivatedRoute)) { return this._ActivatedRoute_52; }
    if ((token === import33.NoPreloading)) { return this._NoPreloading_53; }
    ...
    if ((token === import33.PreloadAllModules)) { return this._PreloadAllModules_56; }
    if ((token === import8.ROUTER_INITIALIZER)) { return this._ROUTER_INITIALIZER_57; }
    if ((token === import48.APP_BOOTSTRAP_LISTENER)) { return this._APP_BOOTSTRAP_LISTENER_58; }
    if ((token === import34.PositioningService)) { return this._PositioningService_59; }
    if ((token === import35.ComponentLoaderFactory)) { return this._ComponentLoaderFactory_60; }
    if ((token === import74.AuthHttp)) { return this._AuthHttp_61; }
    if ((token === import36.DataService)) { return this._DataService_62; }
    if ((token === import37.YQLService)) { return this._YQLService_63; }
    if ((token === import38.NoticeBoardService)) { return this._NoticeBoardService_64; }
    if ((token === import39.ToastService)) { return this._ToastService_65; }
    if ((token === import40.UserService)) { return this._UserService_66; }
