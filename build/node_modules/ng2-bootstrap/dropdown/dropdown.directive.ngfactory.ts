...
import * as import0 from 'ng2-bootstrap/dropdown/dropdown.directive';
...
export class Wrapper_DropdownDirective {
  ...
  constructor(p0:any,p1:any,p2:any) {
    this._changed = false;
    this.context = new import0.DropdownDirective(p0,p1,p2);
  ...
  checkHost(view:import2.AppView<any>,componentView:import2.AppView<any>,el:any,throwOnChange:boolean):void {
    const currVal_4:any = (this.context.isOpen && !this.context.isBs3);
    ...
    const currVal_6:any = this.context.isOpen;
    if (import3.checkBinding(throwOnChange,this._expr_6,currVal_6)) {
      view.renderer.setElementClass(el,'active',currVal_6);
      this._expr_6 = currVal_6;
    }
    const currVal_7:any = this.context.addClass;
  ...
  subscribe(view:import2.AppView<any>,_eventHandler:any,emit0:boolean,emit1:boolean):void {
    ...
    if (emit1) { (this.subscription1 = this.context.isOpenChange.subscribe(_eventHandler.bind(view,'isOpenChange'))); }
  }
}