...
import * as import0 from 'ng2-bootstrap/popover/popover.directive';
...
export class Wrapper_PopoverDirective {
  ...
  constructor(p0:any,p1:any,p2:any,p3:any,p4:any) {
    this._changed = false;
    this.context = new import0.PopoverDirective(p0,p1,p2,p3,p4);
  ...
  check_popover(currValue:any,throwOnChange:boolean,forceUpdate:boolean):void {
    if ((forceUpdate || import3.checkBinding(throwOnChange,this._expr_0,currValue))) {
      this._changed = true;
      this.context.popover = currValue;
  ...
  check_triggers(currValue:any,throwOnChange:boolean,forceUpdate:boolean):void {
  ...
  check_container(currValue:any,throwOnChange:boolean,forceUpdate:boolean):void {
