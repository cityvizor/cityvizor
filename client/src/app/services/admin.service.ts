...
export class AdminService {
  ...
  async createProfile(profile: Profile) {
    const response = await this.http
      .post(this.root + "/profiles", profile, {
        observe: "response",
        responseType: "text",
      })
      .toPromise();
    return this.http
      .get<any>(this.root + response.headers.get("location"))
      .toPromise();
  }

  saveProfile(profileId: number, profile: Partial<Profile>) {
    return this.http
      .patch<any>(this.root + "/profiles/" + profileId, profile)
      .toPromise();
  }

  deleteProfile(profileId: number) {
    return this.http
      .delete<any>(this.root + "/profiles/" + profileId)
      .toPromise();
  }
  ...
  saveProfileAvatar(profileId: number, data: FormData) {
    return this.http
      .put(this.root + "/profiles/" + profileId + "/avatar", data, {
        responseType: "text",
      })
      .toPromise();
  }
  ...
  deleteProfileAvatar(profileId: number) {
    return this.http
      .delete(this.root + "/profiles/" + profileId + "/avatar", {
        responseType: "text",
      })
      .toPromise();
  }
  ...
  getProfileYears(profileId: Profile["id"]) {
    return this.http
      .get<BudgetYear[]>(this.root + "/profiles/" + profileId + "/years")
      .toPromise();
  }
  createProfileYear(
  ...
  deleteProfileYear(profileId: Profile["id"], year: number): Promise<any> {
    return this.http
      .delete(this.root + "/profiles/" + profileId + "/years/" + year, {
        responseType: "text",
      })
      .toPromise();
  }
  ...
  generateProfileImportToken(profileId: Profile["id"]) {
    return this.http
      .get(this.root + "/profiles/" + profileId + "/import-token", {
        responseType: "text",
      })
      .toPromise();
  }
  resetProfileImportToken(profileId: Profile["id"]) {
    return this.http
      .delete(this.root + "/profiles/" + profileId + "/import-token", {
        responseType: "text",
      })
      .toPromise();
  }
  ...
  getProfileImports(profileId: Profile["id"]) {
    return this.http
      .get<Import[]>(this.root + "/profiles/" + profileId + "/imports")
      .toPromise();
  }
  ...
  getUserProfiles(userId: User["id"]) {
    return this.http
      .get<Profile["id"][]>(this.root + "/users/" + userId + "/profiles")
      .toPromise();
  }

  checkLogin(login: User["login"]) {
    return this.http
      .get<boolean>(this.root + "/users/check-login/" + login)
      .toPromise();
  }
  async createUser(userData) {
    const response = await this.http
      .post(this.root + "/users", userData, {
        observe: "response",
        responseType: "text",
      })
      .toPromise();
  ...
  saveUser(userId: User["id"], userData: Partial<User>) {
    return this.http
      .patch<any>(this.root + "/users/" + userId, userData)
      .toPromise();
  }
  saveUserProfiles(userId: User["id"], managedProfiles: Profile["id"][]) {
    return this.http
      .put<any>(this.root + "/users/" + userId + "/profiles", managedProfiles)
      .toPromise();
  }
  deleteUser(userId: User["id"]) {
    return this.http
      .delete(this.root + "/users/" + userId, { responseType: "text" })
      .toPromise();
  }
  ...
  getPboCategories(): Promise<PboCategory[]> {
    return this.http
      .get<PboCategory[]>(this.root + "/pbo-categories")
      .toPromise();
  }
