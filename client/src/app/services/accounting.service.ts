...
export class AccountingService {
  config: {
    ...
    municipality: {
      exp: {
        codelistGroup: "paragraph-groups",
        codelist: "items",
        field: "paragraph",
    ...
    pbo: {
      exp: {
        codelistGroup: "pbo-su-exp-groups",
        codelist: "pbo-su",
        field: "expenditures",
        amount: "expenditureAmount",
        budgetAmount: "budgetExpenditureAmount",
      ...
      inc: {
        codelistGroup: "pbo-su-inc-groups",
        codelist: "pbo-su",
        field: "incomes",
        amount: "incomeAmount",
        budgetAmount: "budgetIncomeAmount",
  ...
  async getGroupEvents(
    ...
    if (profile.type == "municipality") {
      events = await this.dataService.getProfileAccountingEvents(
        profile.id,
        year,
        typeConfig.field,
        groupId
