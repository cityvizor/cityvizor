...
import { ParagraphNamesCodelist } from 'app/shared/schema/codelist';
...
@Component({
	...
	templateUrl: 'expenditure-viz.component.html',
	styleUrls: ['../../../shared/styles/inc-exp-viz.scss']
})
export class ExpenditureVizComponent {
	...
	setData(paragraphNames, budget: TreeBudget, events) {
		...
		budget.paragraphs.forEach(paragraph => {
			...
			let groupId = String(paragraph.id).substring(0, 2);
