exports.up = async function (knex) {
  return knex.schema.createTable('app.import_formats', table => {
      ...
      return knex.schema.alterTable('app.imports', table => {
        table.string('format', 20).notNullable().default('cityvizor').references('format').inTable('app.import_formats')
