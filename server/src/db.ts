...
else if ('user' in knexConfig.connection && 'database' in knexConfig.connection)
  connectionString =
    knexConfig.connection.user + '@' + knexConfig.connection.database;
else if ('filename' in knexConfig.connection)
