    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, db_1.db("data.years").insert({ profileId: req.params.profile, year: req.body.year, hidden: false }, ["id", "profile", "year"])];
            case 2:
                year = _a.sent();
                _a.label = 3;
            case 3:
