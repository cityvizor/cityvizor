...
exports.router.get("/", express_dynacl_1.default("profile-contracts", "list"), function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    var contracts;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, db_1.db("contracts")
