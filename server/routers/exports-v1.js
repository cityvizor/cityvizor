...
router.get("/profiles/:profile/budgets", etlFilter({visible:true}), acl("budgets", "list"), (req,res,next) => {
...
router.get("/profiles/:profile/events/:year", etlFilter({visible:true}), acl("budgets", "read"), (req,res,next) => {
...
router.get("/profiles/:profile/budgets/:year", etlFilter({visible:true}), acl("budgets", "read"), (req,res,next) => {
...
router.get("/profiles/:profile/payments/:year", etlFilter({visible:true}), acl("payments", "read"), (req,res,next) => {
