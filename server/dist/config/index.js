...
exports.default = {
    ...
    static: {
        ...
        index: path_1.default.join(environment.staticFiles, "index.html")
    },
    storage: {
        tmp: path_1.default.resolve(environment.tmpDir),
        avatars: path_1.default.resolve(environment.storageDir, "avatars")
    },
    jwt: {
