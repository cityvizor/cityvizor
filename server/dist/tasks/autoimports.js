...
module.exports = function () {
    return __awaiter(this, void 0, void 0, function () {
        var etls, _i, etls_1, etl, importer, options;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    console.log("Autoimport started!");
                    return [4 /*yield*/, ETL.find({ "enabled": true }).populate("profile", "_id name")];
                case 1:
                    etls = _a.sent();
                    _i = 0, etls_1 = etls;
                    _a.label = 2;
                case 2:
                    if (!(_i < etls_1.length)) return [3 /*break*/, 5];
                    etl = etls_1[_i];
                    console.log("=====");
                    console.log("Starting autoimport for profile " + etl.profile.name + ", year " + etl.year);
                    try {
                        importer = new Importer(etl);
                    ...
                    return [4 /*yield*/, new Promise(function (resolve, reject) {
                            importer.importUrl(function (err, result) {
                                if (err)
