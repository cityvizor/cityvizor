    ...
    Importer.prototype.extractZip = function (zipFile) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        unzipDir = path_1.default.join(config_1.default.storage.tmp, "import-zip");
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 5, , 6]);
                        // TODO: redo after testing with Gordic
                        // If zip file provided choose the largest CSV as dataFile and second largest as 
                        return [4 /*yield*/, fs_extra_1.default.remove(unzipDir)];
                    case 2:
                        // TODO: redo after testing with Gordic
                        // If zip file provided choose the largest CSV as dataFile and second largest as 
                        _a.sent();
                        return [4 /*yield*/, fs_extra_1.default.ensureDir(unzipDir)];
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, new Promise(function (resolve, reject) {
                                var stream = fs_extra_1.default.createReadStream(zipFile).pipe(unzip_1.default.Extract({ path: unzipDir }));
                    ...
                    case 6: return [4 /*yield*/, fs_extra_1.default.readdir(unzipDir)];
                    case 7:
                        csvFiles = (_a.sent())
                            .filter(function (file) { return file.match(/\.csv$/i); })
                            .map(function (file) {
                            var csvPath = path_1.default.join(unzipDir, file);
                            return {
                                path: csvPath,
                                size: fs_extra_1.default.statSync(csvPath).size
                            };
                        });
