...
var ImportParser = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        eventsFile = fs_extra_1.default.createReadStream(files.eventsFile);
                    ...
                    case 2:
                        ...
                        dataFile = fs_extra_1.default.createReadStream(files.dataFile);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        var error = false;
                        var parser = csv_parse_1.default({ delimiter: ",", columns: function (line) { return _this.parseHeader(line, headerNames); } });
    ...
    ImportParser.prototype.parseEvents = function (eventsFile) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        var error = false;
                        var parser = csv_parse_1.default({ delimiter: _this.etl.delimiter, columns: function (line) { return _this.parseHeader(line, eventHeaderNames); } });
                        parser.on("error", function (err) { return (error = true, reject(err)); });
                        parser.on("end", function () { return !error && resolve(); });
    ...
    ImportParser.prototype.createReader = function () {
        var _this = this;
        var reader = new stream_1.Writable({
            objectMode: true,
